  ...
  .then(x => {
   ...
   .catch(() => {
    ...
    fetch(`https://api2.splinterlands.com/players/quests?username=${username}`,
      ...
      .catch(e => console.log('Verifique se o servidor do Splinterlands está em manutenção / Você está usando nome de usuário ou e-mail? / Por favor use o nome de usuário'))
  })
)
